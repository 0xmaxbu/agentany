...
const projectStore = new ProjectStore(db); // 项目 + 成员（步骤 b）：与 store/userStore 共享同一 db
...
const deps: RunDeps = { store, userStore, streamRegistry, projectStore, eventBus, runRegistry };
